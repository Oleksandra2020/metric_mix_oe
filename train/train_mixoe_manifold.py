...
wandb.init(
    ...
    config={
        ...
        "epochs": args.epochs,
        "mix_op": "manifold_fixed",
    },

    # group="split{}".format(args.split)
    group="manifold_mixup_fixed=1_epochs={}".format(args.epochs),
...
if args.save_dir is None:
    mixoe_related = 'manifold_mixup_fixed=1'
...
def train():
    ...
    for x, y in batch_iter:
        ...
        mixed_x, soft_labels = net(x, oe_x, one_hot_y, num_classes, False, False, lam, 1)
