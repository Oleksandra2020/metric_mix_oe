...
def train():
    ...
    for x, y in batch_iter:
        ...
        for i in range(embeddings.shape[0]):
            ...
            if anchor_mx:
                anchor = lam * anchor + (1 - lam) * negative
            else:
                positive = lam * positive + (1 - lam) * negative
            count += positive_inds.shape[0]
...
if __name__ == "__main__":
    ...
    last_row = ["io_i1_o_rand", args.alpha, args.beta, args.epochs,
                args.batch_size, args.margin, args.mixup]

    csv_file_name = "/home/hutorole/code/metric_oe/csv_results/dataset={}_beta={}_epochs={}_margin={}_mixup={}_id={}_io_i1_o_rand_1.csv".format(
    ...
    for spl in range(splits):
        ...
        for rn in range(runs):
            ...
            args.save_dir = os.path.join(
                ...
                'split_{}'.format(spl),
                '{}_{}_epochs={}_bs={}_ind={}_outl_class={}_outl_num={}_margin={}_mixup={}_id={}_io_i1_o_rand_1'.format(
