...
wandb.init(
    ...
    group="2label_epochs={}".format(args.epochs),
...
def train():
    ...
    for x, y in batch_iter:
        ...
        mixed_loss = soft_xent(net(x), soft_labels)
...
wandb.log({"test_acc": acc, "tnr_fine_conf": tnrs['fine'], "tnr_coarse_conf": tnrs['coarse'],
           "tpr": tpr, "tnr_fine_dist_20": tnr_fine, "tnr_coarse_dist_20": tnr_coarse})

acc, tnrs, tpr, tnr_fine, tnr_coarse = main_eval(chkpnt_path, train_set, 10)
wandb.log({"tnr_fine_dist_10": tnr_fine, "tnr_coarse_dist_10": tnr_coarse})

acc, tnrs, tpr, tnr_fine, tnr_coarse = main_eval(chkpnt_path, train_set, 5)
wandb.log({"tnr_fine_dist_5": tnr_fine, "tnr_coarse_dist_5": tnr_coarse})

acc, tnrs, tpr, tnr_fine, tnr_coarse = main_eval(chkpnt_path, train_set, 50, 10)
wandb.log({"tnr_fine_dist_50_w10": tnr_fine, "tnr_coarse_dist_50_w10": tnr_coarse})

acc, tnrs, tpr, tnr_fine, tnr_coarse = main_eval(chkpnt_path, train_set, 30, 10)
wandb.log({"tnr_fine_dist_50_w10": tnr_fine, "tnr_coarse_dist_30_w10": tnr_coarse})

acc, tnrs, tpr, tnr_fine, tnr_coarse = main_eval(chkpnt_path, train_set, 20, 10)
wandb.log({"tnr_fine_dist_50_w10": tnr_fine, "tnr_coarse_dist_20_w10": tnr_coarse})
